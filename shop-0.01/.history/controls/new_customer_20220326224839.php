    ...
    <form id='new-customer-form' name='new-customer-form' method="post">
        <fieldset><legend>Personalia</legend>
            <p>
                ...
                <input type="text" id="firstname" name="firstname" minlength="2" maxlength="50" size="50" pattern="[A-Z]+" required>
            </p>
            <p>
                <label for="lastname"> Last Name </label>
                <input type="text" id="lastname" name="lastname" minlength="2" maxlength="50" size="50" pattern="[A-Z]+" required>
            </p>
        </fieldset>
        ...
        <fieldset><legend>Mailing Address</legend>
            <p>
                ...
                <input type="text" id="street" name="street" minlength="2" maxlength="50" size="50" required> 
            </p>
            <p>
                <label for="city"> City </label>
                <input type="text" id="city" name="city" minlength="2" maxlength="50" size="50" required> 
            </p>
            <p>
                ...
                <select id="state" name="state" required>
                    ...
                    <option value="TN">Tennessee</option>label
