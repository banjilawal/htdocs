...
<main>
    <form id='new-customer-form' name='new-customer-form' method="post">
        <fieldset><legend>Personalia</legend>
            ...
            <input type="text" id="firstname" name="firstname" minlength="2" maxlength="20" size="50" required>

            <label for="lastname"> Last Name </label>
            <input type="text" id="lastname" name="lastname" minlength="2" maxlength="20" size="50" required>
        </fieldset>
