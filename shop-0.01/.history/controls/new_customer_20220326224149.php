...
<main>
    <form id='new-customer-form' name='new-customer-form' method="post">
        <fieldset><legend>Personalia</legend>
            ...
            <input type="text" id="firstname" name="firstname" minlength="2" maxlength="50" size="50" required>
        ...
        <fieldset><legend>Mailing Address</legend>
            <p>
                ...
                <input type="text" id="street" name="street" minlength="2" maxlength="100" size="100" required> 
            </p>
            <p>
                <label for="city"> City </label>
                <input type="text" id="city" name="city" minlength="2" maxlength="100" size="100" required> 
