<?php
   ...
   # define ('IMAGE_PATH', 'assets/images/');
    ...
    define ('FORM_PATH', PROJECT_PATH . '/view');
    define ('QUERY_PATH', PROJECT_PATH . '/db');
    define ('WEB_PAGE_PATH', PROJECT_PATH . '/display');
    ...
    define ('DB_USER', 'ics325sp2213');
    define ('DB_PASS', '3677');
    define ('DB_NAME', 'ics325sp2213');
...
/*
    function random_image () {
        ...
        $path = trim((IMAGE_PATH . $files[array_rand($files,1)]), " ");

        return $path;
    } // close randomImagePath;
    echo random_image();
    echo  '<img src="' . random_image() . '" width="300" height="400">';
*/
?>