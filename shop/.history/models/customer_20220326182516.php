<?php
    ...
    class Customer {
        ...
        public function __construct($firstname, $lastName, $birthdate, $phone, $email, $address) {
            ...
            if (get_class($address) != 'StreetAddress') {
        ...
        public function __toString() {
           ...
           $string .= 'phone: ' . $this->phone->toString() . '<br>' . PHP_EOL;
    ...
    'CN-38-VDL-M7', 'Hannia', 'Free', '1963-11-12', '(236) 155-1825', 'hannia-free@aim.com', , '37'

    $phone = new Phone('317', '735','8016');
    $address = new Address('11681 Theatre Drive North', 'Champlin', 'MN', '55316');
    $customer = new Customer('Adaya', 'Crawford', '1992-04-27', , 'adaya.crawford@yahoo.com', 12 );
