<?php
    class ExpirationDate {
        ...
        public function __toString() {
           ...
           return $this->street . ' ' . $this->city . ', ' . $this->state . ' ' . $this->zip;             return $this->street . ' ' . $this->city . ', ' . $this->state . ' ' . $this->zip; 
    ...
    class CreditCard {
        ...
        public function set_expiration ($date) { 
            if (get_class($date) != 'ExpirationDate')
                throw new Exception("date is not an expiration date");
    ...
    $date = new ExpirationDate(5, 26);
    echo 'exp: ' . $date . '<br>';
    $code = new SecurityCode(902);
    $card = new CreditCard('5043-55422-2462', $date, $code);
    echo $card;
