        ...
        <fieldset><legend>Credit Card</legend>
            ...
            <fieldset><legend>Expiration</legend>
                ...
                <select>
                    ...
                    <option value="22">January</option>
                    <option value="23">February</option> 
                    <option value="24">March</option>
                    <option value="25">April</option>  
                    <option value="26">May</option>
                    <option value="27">June</option> 
                    <option value="28">July</option>
