...
<main>
    <form id='new-customer-form' name='new-customer-form' method="post">
        <fieldset><legend>Personalia</legend>
            ...
            <input type="text" id="firstname" name="firstname" length="20" required="true">

            <label for="lastname">Last Name</label>
            <input type="text" id="lastname" name="lastname" length="20" required="true">
        </fieldset>

        <fieldset><legend>Mailing Adddress</legend>
            <p>
                <label for="street">Street</label>
                <input type="text" id="street" name="street" length="100" required="true"> 
            </p>

            <p>
                <label for="city">City</label>
                <input type="text" id="city" name="city" length="100" required="true"> 
            </p>

            <p>
                <label for="state">State</label>
                <select id="state" name="state" required="true">
                    <option value="" default="true">--Please Select Your State--</option>
