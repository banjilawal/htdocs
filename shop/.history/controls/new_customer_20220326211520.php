...
<main>
    <form id='new-customer-form' name='new-customer-form' method="post">
        <fieldset><legend>Personalia</legend>
            ...
            <input type="text" id="first-name" name="first-name" length="20">

            <labb        <p><label for="patient_firstName">First Name: <input type="text" id="patientFirstName" name="patient_firstName"></label> 
