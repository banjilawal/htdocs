...
<main>
    <form id='new-customer-form' name='new-customer-form' method="post" action="../control/create_customer.php">
        <fieldset><legend>Personalia</legend>
            <p>
                <label for='firstname'> First Name </label>
                <input type="text" id="firstname" name="firstname" minlength="2" maxlength="50" size="60" required>
            </p>
            <p>
                <label for="lastname"> Last Name </label>
                <input type="text" id="lastname" name="lastname" minlength="2" maxlength="50" size="60" required>
            </p>
        </fieldset>
        ...
        <fieldset><legend>Password</legend>
            <p>
                ...
                <input type="password" id="pass" name="pass" minlength="2" maxlength="15" size="25" required>          
            </p>
            <p>
                <label for="confirmPass">Confirm Password</label>
                <input type="password" id="confirmPass" name="confirmPass" minlength="2" maxlength="15" size="25" required>          
            </p>
        </fieldset>
