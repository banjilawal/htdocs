...
use CreditCard as GlobalCreditCard;
    ...
    $address = new StreetAddress('CN-72-FPN-VO', , '250 Turners Crossroad South', 'Golden Valley', 'MN', '55416', '1'
    )
    ...
    $customer = new Customer('Adaya', 'Crawford', '1992-04-27 00:00:00', '(317) 735-8016', 'adaya.crawford@yahoo.com');
    $customer-
