<?php
    ...
    function review_query ($proteinBar) {
        ...
        $query = 'SELECT c.id customerID, firstname, lastname, birthdate, email, phone, street, city, state, zip,
        r.id reviewID, r.stars, r.comments, p.id productID, name, description, grams, retailPrice
