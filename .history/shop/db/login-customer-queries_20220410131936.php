<?php
    ...
    function login ($username, $password) {
        ...
        $query = 'SELECT a.username, a.id accountID, 
        a.pass, 
    c.id customerID, firstname, lastname, birthdate, email, phone, street, city,
    state, zip
    FROM shop.customer_accounts a
    INNER JOIN shop.customers c
    ON a.username = c.username
    WHERE a.username = 'mikail.goebel' AND pass = '=w2a.58W>1c"k]4v,65y';
