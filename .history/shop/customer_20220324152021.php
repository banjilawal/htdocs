...
use CreditCard as GlobalCreditCard;
    ...
    class Customer {
        ...
        public function set_firstname ($name) { return $this->firstname; }
        public function set_lastname ($name) { return $this->lastname; }
        public function set_birthdate ($date) { return $this->birthdate; }
        public function set_phone ($phone) { return $this->phone; }
        public function set_email ($email) { return $this->email; }
        public function set_street ($street) { return $this->street; }
        public function set_city ($city) { return $this->city; }
        public function set_state ($state) { return $this->state; }
        public function set_zip ($zip) { return $this->zip; }
        public function set_card ($card) { return $this->card; }
