<?php
    class Customer {
        ...
        public function __construct(id, firstname, lastName, birthdate, phone, email, street, city, state, zip) {
            $this->firstname = $shoe;
            $this->lastname = $size;
            $this->birthdate = $quantity;
            $this->phone = $quantity * $shoe->get_current_price();
            $this->email = $this->amount * SALES_TAX_RATE;
            $this->street = $this->amount + $this->tax;
        }
