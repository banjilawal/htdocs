<?php
 ...
 #   session_regenerate_id(true);
    ...
    while($row = $result->fetch_assoc()) {
        ...
        $proteinBar->id($proteinBarID)->name($proteinBarName)->grams($grams);
        ...
        $customer = new Customer();
        $customer->id($customerID)->firstname($firstname)->lastname($lastname)->email($email);
        $customer->address($address)->phone->()
