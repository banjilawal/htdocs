<?php
 ...
 #   session_regenerate_id(true);
    ...
    $mysqli = db_connect();
    $result = $mysqli->query("SELECT id, name, description, grams, retailPrice FROM shop.products;" 'CN-27-QQN-P3', 'Kaliah', 'Furman', 'kaliah_furman@web.de', '(573) 246-0844', '8545 Chalet Road', 'Bloomington', 'MN', '55438', 'GJSEB-15315-UAKU-563', '2022-02-02 09:22:04', NULL, NULL, 'Saraban', '2.99', '132.51', 'cancelled'
);
