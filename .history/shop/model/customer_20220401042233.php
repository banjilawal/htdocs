<?php
    ...
    class Customer {
        ...
        public function __construct() {
            $this->birthday = new DateTime('0000-01-1');
        ...
        public function firstname ($name) { 
            if (preg_match(NAME_PATTERN, $name) != 1) {
                throw new Exception("first name can only have letters and a sp");
            } 
            $this->firstname = $name;
            return $this;
        }
        public function lastname ($name) { 
            if (preg_match(NAME_PATTERN, $name) != 1) {
                throw new Exception("last name can only have letters and space");
            } 
            $this->lastname = $name;
            return $this;
        }
