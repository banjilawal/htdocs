<?php
    DEFINE ('CREDIT_CARD_PATTERN', '/^([0-9]{3,}-){4,}$/i');
    class CreditCard {
        private $number;
    ...
    $card = new CreditCard();
    $card->number("037-10724-0307-8385-1280")->expiration((new DateTime('2020-10-24')))->security_code(677);#month(5)->year(23)->security_code(677);
    echo $card->print_number();
    echo $card->to_table();
    #*/
