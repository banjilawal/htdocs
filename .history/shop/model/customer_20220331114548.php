    ...
    class Customers {
        ...
        public function to_table () {
            ...
            $elem = '<table class="table" id="customers-table" name="customers-table">'
                ...
                . '<th class="customers-column">First Name/th>'
                . '<th class="card-column">Last Name/th>'
                . '<th class="card-column">Phone Name/th>'
                . '<th class="card-column">EmailName/th>'
                . '<th class="card-column">Address Name/th>'
                . '</tr>'
                . '</thead>'
                . '<tbody class="table-body" id="cards-table-body" name="customers-table-body">';
