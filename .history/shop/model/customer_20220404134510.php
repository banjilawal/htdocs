<?php
    ...
    class Customer {
        ...
        public functions cards ($creditCardBag) {
            if (get_class($address) != 'CreditCardBag') {
                throw new Exception("cannot  is not of the correct type");
            }
        }
            ...
            $elem = '<table class="table" id="customers-table" name="customers-table">'
                ...
                foreach ($this->list as $customer) {
                   $elem .= '<tr id="' . $customer->get_id() . '" name="' . $customer->get_id() . '" onclick="send(this)">'
                        ...
                        . '<td>' . $customer->get_address()->get_street() . '</td>'
                        . '<td>' . $customer->get_address()->get_city() . '</td>'
                        . '<td>' . $customer->get_address()->get_state() . '</td>'
                        . '<td>' . $customer->get_address()->get_zip() . '</td>'
                        . '</tr>';
                } 
