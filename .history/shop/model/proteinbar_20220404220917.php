<?php
   ...
   # echo  '<img src="' . random_image_path() . '" width="300" height="400">';
    ...
    class ProteinBar {
        ...
        public function averageStars ($average) { 
        ...
        public function to_row () {
            $elem = '<tr id="' . $this->id . '" name="' . $this->id . '" onclick="send_protein_ba(this)">'
        ...
        public function get_averageStars () { return $this->averageStars; }
