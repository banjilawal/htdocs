<?php
    ...
    class ProteinBar {
        ...
        public function get_image_path () { return $this->picture; }
    ...
    class ProteinBars {
        ...
        public function __toString() {
            ...
            foreach ($this->list as $proteinBar) { $string  .= $proteinBa . '<br>' . PHP_EOL; }
            return $string;
        } // close toString
    ...
    $bar->description('oat bran,bagels, sauce,canned,w/onions,tomato products, unpr,frz,kashi three cheese ravioli with med');
    $bars->add($bar);
