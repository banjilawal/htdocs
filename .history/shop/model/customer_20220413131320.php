<?php
    ...
    class Customer {
        ...
        public function get_cards () { return $this->cards; }
    ...
    class CustomerBag {
        ...
        public function __toString() {
            ...
            foreach ($this->list as $id => $customer) { $string  .= $this->list[$id] . '<br>' . PHP_EOL; }#$customer . '<br>' . PHP_EOL; }
            return $string;
        } // close toString
