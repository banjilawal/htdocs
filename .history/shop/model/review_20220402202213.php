<?php
    ...
    class Review {
        ...
        public function get_proteinBarr () { return $this->proteinBar; }
        ...
        public function to_row () {
            $elem = '<tr id=">' .$this->id . '" onclick="send(this)">'
                . '<td>'
                    . $this->proteinBar->get_name() . '</td>'
                . '<td>'
                . $this->proteinBar->get_name() 
                . ' Price: ' . $this->bar->get_retailPrice() . '<p></p>'
            . '</td>'
                . '<td>' 
                    . $this->customer->get_firstname() . ' ' . $this->customer->get_lastname()
    ...
    $review->bar($proteinBar)->customer($customer);
