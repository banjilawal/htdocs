            ...
            . '<thead>'
                ...
                . '<tbody>'
                    . '<tr>'
                        ...
                        . '<td>' . $this->retailPrice . '</td>'
                        . '<td>'
                            . '<p><button type="button" id="buy-protein-bar-button" onclick="start-return-process()">I Want to Return</button></p>'
                            . '<p><button type="button" id="review-protein-bar-button" onclick="start-comment-process()">Give Rating</button></p>'
                        . '</td>'
                    . '</tr>'     
                    . '</tr>'
                . '</tbody>'      
