<?php
  ...
  $bar = (new ProteinBar ())->id('PN-BEK-324-U')->nam, 'Nyffenegger', 'mature seeds,navy,ckd,bld,beans,w/salt, unckd,dehyd (low-moisture),prunes, creme filling,choc sndwch', '94', '1.99', '18'
