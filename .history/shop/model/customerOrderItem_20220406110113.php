<?php
    class CustomerOrderItem {
        ...
        public function get_proteinBar () { return $this->item->get_quantity(); }
            ...
            $elem = '<table class>'
                ...
                . '<tbody>';
                    for ($index = 1; $index < sizeof($this->list); $index++) {   
                       $elem .=  '<tr>'
                            . '<td>' . $index .'</td>'
                            . '<td><img src="' . $this->list[$index]->get_proteinBar()->get_imagePath() . '" width="300" height="400"></td>'
                            ...
                            . '<td>' . $this->list[$index]->get_arrivalDate()->format('Y-m-d hh:mm:s') . '</td>'
                        . '</tr>';    
                    }  
            $elem .= '</tbody></table>';
