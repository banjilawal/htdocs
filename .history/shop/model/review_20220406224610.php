<?php
    ...
    class Review {
        ...
        public function get_name () { return $this-proteinBar->get_name(); }
        public function get_image_path () { return $this-proteinBar->get_imagePath(); }

        public function get_first_name () { return $this->customer->get_firstname(); }
        public function get_last_name () { return $this->customer->get_lastname(); }
                ...
                . '<tbody>';
                    ...
                    if (is_null($customerID) == false) {
                        foreach ($this->list as $id => $review) {
                            ...
                            . '<td>' . $this->list[$id]->get_name() . '</td>'
                            . '<td>' . $this->list[id]->gettimestamp->format('Y-m-d hh:mm:ss') . '</td>'
                            . '<td>' . $this->comments . '</td             
                        }
                    }
