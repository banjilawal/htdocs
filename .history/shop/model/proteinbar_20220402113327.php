...
*/
    ...
    $proteinBar = new ProteinBar();
    $proteinBar->id('PN-JIK-382-X')->name('Saraban')->grams(95)->retailPrice(1.99);
    ...
    $proteinBar = new ProteinBar();
    $proteinBar->id('PN-SBO-248-P')->name('Symphonists')->grams(48)->retailPrice(2.99);
    ...
    $bar->description('mature seeds,navy,ckd,'PN-WUK-857-T'bld,beans,w/salt, unckd,dehyd (low-moisture),prunes, creme filling,choc sndwch');
    $bag->add($proteinBar);
  ...
  #  ?, , , 'm and ms crispy choc c and ies,mars snackfood us,c and ies, apl),grp,ocean spry,w/vit c,ruby red grp', '59', '2.99', '25'
 #   ?, , 'Germa', 'fruit-flavored,propel zero,non-carbonated,beverages, white,pita,enriched,bread, reduced fat ginger s', '72', '2.99', '26'
    ...
    ?, , 'Instrumentalis', 'thigh,broilers or fryers,meat and skn,ckd,chicken,stwd, crackers (made with whl grain),cheez-it,suns', '85', '2.99', '23'
