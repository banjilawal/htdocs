<?php
    ...
    define ('MIN_GRAMS', 10);
    define ('MAX+_GRAMS', 100);
    define ('LOWEST_PRICE', 1.05);
    define ('HIGHEST_PRICE')
    

    CONSTRAINT product_grams_ck CHECK (grams BETWEEN 10 AND 100),
	CONSTRAINT product_retailPrice_ck CHECK (retailPrice BETWEEN 0.00 AND 10.99),
	CONSTRAINT product_id_ck CHECK (id REGEXP 'PN-[A-Z][A-Z][A-Z]-[2-9][2-9][2-9]-[P-Z]$')
    class ProteinBar {
        private $id;
        private $picture;
        private $name;
