...
*/
    ...
    $proteinBar = new ProteinBar();
    $proteinBar->id('PN-XTP-653-P')->name('Saraban')->grams(95)->retailPrice(1.99);
    ...
    $proteinBar = new ProteinBar();
    $proteinBar->id('PN-XPF-327-P')->name('Symphonists')->grams(48)->retailPrice(2.99);
   ...
   # ?, 'PN-FTN-373-V', ', 'oat bran,bagels, sauce,canned,w/onions,tomato products, unpr,frz,kashi three cheese ravioli with med', '90', '2.99', '24'
  #  ?, 'PN-SBO-248-P', , 'm and ms crispy choc c and ies,mars snackfood us,c and ies, apl),grp,ocean spry,w/vit c,ruby red grp', '59', '2.99', '25'
 #   ?, , 'Germa', 'fruit-flavored,propel zero,non-carbonated,beverages, white,pita,enriched,bread, reduced fat ginger s', '72', '2.99', '26'
    
    #echo $bag->to_table();

    ?, 'PN-LYI-225-R', 'Dubar', 'raw,oriental,radishes, lamb,meat,junior,babyfood, meat only,domesticated,raw,duck, lrg end (ribs 6-9', '69', '3.99', '22'
    ?, 'PN-WUK-857-T', 'Instrumentalis', 'thigh,broilers or fryers,meat and skn,ckd,chicken,stwd, crackers (made with whl grain),cheez-it,suns', '85', '2.99', '23'
    ?, 'PN-FTN-373-V', 'Saraban', 'oat bran,bagels, sauce,canned,w/onions,tomato products, unpr,frz,kashi three cheese ravioli with med', '90', '2.99', '24'
    ?, 'PN-SBO-248-P', 'Symphonists', 'm and ms crispy choc c and ies,mars snackfood us,c and ies, apl),grp,ocean spry,w/vit c,ruby red grp', '59', '2.99', '25'
    ?, 'PN-XPF-327-P', 'Germa', 'fruit-flavored,propel zero,non-carbonated,beverages, white,pita,enriched,bread, reduced fat ginger s', '72', '2.99', '26'
    ?, 'PN-ARI-842-U', 'Bondi', 'blade rst,chuck,ln and fat,1/8 inchfat,beef,sel,raw, hot cocoa,choc bev,homemade,milk, 5th avenue c ', '72', '2.99', '27'
