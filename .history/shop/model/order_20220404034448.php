    ...
    public function __toString() {
        ...
        foreach ($this->list as $item) { 
            $string  .=  'orderID:' . $item->get_id() . ' customerID:' . $item->get_customer()->get_id() 
                ...
                . ' tax:' . $item->get_tax()
                . ' submitted:' . $item->get_submission_time()->format('Y-m-d hh:mm:s') . '<br>'
                . ' estimated delivery:' . $item->get_estimated_delivery()->format('Y-m-d hh:mm:s') . '<br>'
            . ' ' . $item-> get_actual_delivery ()->format('Y-m-d hh:mm:s') . '<p></p>' . '<br>'
            . ' ' . $this->items;
        }
        return $string;
    } 
