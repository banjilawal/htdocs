<?php
  ...
  $bar = (new ProteinBar ())->id('PN-BEK-324-U')->name('Nyffenegger')->grams(94);
  $bar->description('mature seeds,navy,ckd,bld,beans,w/salt, unckd,dehyd (low-moisture),prunes, creme filling,choc sndwch'), '', '1.99', '18'
