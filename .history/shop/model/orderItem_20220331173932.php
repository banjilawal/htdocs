...
;           return $this;
        ...
        public function get_cost () { 
            return ($this->proteinBa->get_retailPrice() * $this->quantity); 
        }
    ...
    class OrderItems {
        ...
        public function add ($item) {
            ...
            $name = $item->get_bar()->get_name();
            if ($this->search_name($name) != null) {
                throw new Exception("The itm is already in the cart");
            }
            $this->list[] = $item;
        }
        ...
        public function search_name ($target) {
            ...
            foreach ($this->list as $item) {
                if ($item->get_bar()->get_name() == $target) {
                    $result = $item;
                    break;
                }
            }
