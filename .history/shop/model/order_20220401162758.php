<?php
        ...
        */
        ...
        public function __toString() {
            $text = $this->id 
                ...
                . ' ' . $this->total  
                . ' ' . $this->tax
                . ' ' . $this->submissionTime->format('Y-m-d hh:mm:s')
                . ' ' . $this->estimatedDelivery->format('Y-m-d hh:mm:s')
                . ' ' . $this->actualDelivery->format('Y-m-d hh:mm:s') 
                . ' ' . $this->items;
    ...
    $order->customer($customer)->submission_date((new DateTime('2022-04')));
    echo '<p>' . $order . '</p><p>' . $order->to_table() . '</p>';
