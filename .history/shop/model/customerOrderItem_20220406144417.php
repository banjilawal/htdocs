            ...
            $elem = '<table>'
                ...
                . '<tbody>'
                    . '<tr>' 
                        ...
                        . '<td>' . $this->arrivalDate->format('Y-m-d hh:mm:s') . '</td>'
                        . '<td>' .
                            . '<p><button type="button" id="return-item-button" onclick="start-return-process()">I Want to Return</button></p>'
                            . '<p><button type="button" id="comment-item-button" onclick="start-comment-process()">I Want to Review the </button></p>'</td>'
                             . 
                    . '</tr>'
                . '</tbody>'
                . '</table>'; 
