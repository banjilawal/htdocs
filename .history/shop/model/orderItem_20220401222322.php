<?php
  ...
  $bar = (new ProteinBar ())->id('PN-BEK-324-U')->name->('Nyffenegger')
  $bar->description('mature seeds,navy,ckd,bld,beans,w/salt, unckd,dehyd (low-moisture),prunes, creme filling,choc sndwch'), '94', '1.99', '18'
