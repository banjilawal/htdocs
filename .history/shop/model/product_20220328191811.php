<?php
    class ProteinBar {
        ...
        public function get_description ($description) { $this->description = $description; return $this;}
        public function get_grams ($grams) { $this->grams = $grams; return $this;}
        public function get_retailPrice ($retailPrice) { $this->retailPrice = $retailPrice; return $this;}
