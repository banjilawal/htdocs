<?php
    ...
    class Order {
        ...
        public function submission_date ($submissionDate) { $this->submissionDate = $submissionDate ; return $this; }
        public function estimated_delivery () { $this->estimatedDeliveryDate = $submissionDate; return $this; }
