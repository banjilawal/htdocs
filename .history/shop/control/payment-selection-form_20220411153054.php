<?php
   ...
   # require_once (MODEL_PATH . '/order.php');
    ...
    if (isset($_SESSION['customer']) == false) {
        $_SESSION['redirectPage'] = '../control/payment-selection-form.php'; #$_SERVER['SCRIPT_NAME'];
...
<form id="select-card-form" name="select-card-form" method="post" action="process-order.php">
    <?php echo $cards->to_selector(); ?>
