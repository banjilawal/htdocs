<?php
    ...
    $conn->query("CALL shop.insert_new_customer_sp($firstname,$lastname,$birthdate,$phone,$email,$street,$city,$stae,$zip) '11124 Quinn Avenue South', 'Bloomington', 'MN', '55437');");
