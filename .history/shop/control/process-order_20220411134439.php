<?php
    ...
    require_once (QUERY_PATH . '/protein-bar-queries.php'); #'../db/protein-bar-queries.php');
    ...
    if (isset($_SESSION['customer']) == false) {
        $_SESSION['redirectPage'] = $_SERVER['SCRIPT_NAME'];
        #echo 'previous page ' . $_SESSION['previousPage'];
        #echo 'script name: ' . $_SERVER['SCRIPT_NAME'];
        header(FORM_PATH . '/login-form-php'); #'../view/login-form.php');       
    }
    else {
