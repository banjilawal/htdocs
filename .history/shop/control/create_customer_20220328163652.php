<?php
    ...
    $conn->query("CALL shop.insert_new_customer_sp($firstname,$lastname,$birthdate,$p,'Robison','2004-08-19','(251) 288-7286', 'eiven_robison@ig.com.br', '11124 Quinn Avenue South', 'Bloomington', 'MN', '55437');");
