<?php
    ...
    $card = new CreditCard();
    $card->number($number)->month($month)->year($year)->security_code($code);
    #echo $card;
    ...
    $customer->firstname($firstname)->lastname($lastname)->phone($phone)->address($address)->card($card)->email($email);  
    ...
    $conn->query("CALL shop.insert_new_customer_sp($firstname,$lastname,$birthdate,$phone,$email,,'Robison','2004-08-19','(251) 288-7286', 'eiven_robison@ig.com.br', '11124 Quinn Avenue South', 'Bloomington', 'MN', '55437');");
