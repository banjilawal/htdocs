<?php
    ...
    $customerID = insert_customer($customerID, $firstname, $lastname, $birthdate, $phone, $email, $street, $city, $state, $zip);
    
    echo '<br>Assigned customerID: ' . $customerID . '<br>'
    
    echo 'customerID: ' . $customerID . $string;
