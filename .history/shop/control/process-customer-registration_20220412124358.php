<?php
    ...
    if (isset($_POST['birthdate'])) $firstname = $_POST['firstname']; 
    if (isset($_POST['phone'])) $firstname = $_POST['lastname']; 
    if (isset($_POST['email'])) $firstname = $_POST['firstname']; 
    if (isset($_POST['street'])) $firstname = $_POST['lastname']; 
    if (isset($_POST['city'])) $firstname = $_POST['firstname']; 
    if (isset($_POST['state'])) $firstname = $_POST['lastname']; 
    if (isset($_POST['zip'])) $firstname = $_POST['firstname']; 
    if (isset($_POST['card'])) $firstname = $_POST['lastname']; 
    if (isset($_POST['expiration'])) $firstname = $_POST['firstname']; 
    if (isset($_POST['securityCode'])) $firstname = $_POST['lastname']; 
    if (isset($_POST['pass'])) $firstname = $_POST['firstname']; 
    if (isset($_POST['confirmPass'])) $firstname = $_POST['lastname']; 
