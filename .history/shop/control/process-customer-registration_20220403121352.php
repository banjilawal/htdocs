<?php
    ...
    function create_db_account ($email) {
        ...
        $query = $mysqli -> query("SELECT d.db, r.role, u.user FROM mysql.roles_mapping r INNER JOIN mysql.user u INNER JOIN mysql.db d ON u.user = d.user ON r.user = u.user;")
