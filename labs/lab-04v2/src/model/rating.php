<?php
    ...
    class Rating {
        ...
        public function set_rating ($number) { 
            if ($number < MIN_RATING || $number > MAX_RATING) {
                throw new Exception($number . ' is outisde the rating range');
                exit(12);                
            }
            $this->rating = $number; 
        }
        ...
        public function to_table () {
            $elem = '<table><thead>'
                ...
                . '<td>'
                    . $this->shoe->get_name() 
                    . ' Price: ' . $this->shoe->report_price() . '<p></p>'
