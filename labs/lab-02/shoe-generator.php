...
*/
    ...
    class ShoeSize {
        ...
        public function setInWide ($in_wide) { $this->in_wide = $in_wide; }
...
*/
    ...
    class Brand {
        ...
        public function get_onSale () { return $this->onSale; }
        public function get_discountRate () { return $this->discountRate; }

        public function set_name ($name) { $this->name = $name; }
        public function set_onSale ($bool) { $this->onSale = $bool; }
        public function set_discountRate ($ratio) { $this->discountRate = $ratio; }

        public function __toString() {
           $string = '[ Brand: ' . $this->name;
           
           if ($this->onSale && $this->discountRate > 0.00)
               $string .= ' ' . ($this->discountRate * 100.00) . '% discount';
    ...
    class Shoes {
        ...
        public function __toString() {
            ...
            foreach ($this->list as $shoe) { //$id => $shoe) {
               // $string .= $id . '=>'. $shoe . '<br>' . PHP_EOL;
               $string .= $shoe . '<br>' . PHP_EOL;
            }
            return $string;
        } // close toString
